...
export default function EditServicePage() {
  ...
  // Find service or fallback to first mock service
  const service = useMemo(() => {
    const found = mockProfileServices.find((s) => String(s.id) === String(rawId));
    return (
      found ??
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <p className="mt-1 text-sm text-muted-foreground md:text-base">
              Atualizando <span className="font-semibold text-primary">{service.name}</span>
            </p>
          </div>
          <button
            type="button"
            className="self-start sm:self-auto flex items-center gap-1.5 rounded-xl border border-destructive/30 bg-destructive/5 px-3 py-2 text-xs font-semibold text-destructive transition-colors hover:bg-destructive/10 cursor-pointer"
          >
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs sm:text-sm text-muted-foreground">
                  Foto de destaque exibida no catálogo de serviços
                </p>
              </div>
            </div>
                ...
                <>
                  ...
                  <div className="text-center">
                    <p className="text-sm font-medium text-foreground">
                      Clique na área para escolher uma nova imagem
                    </p>
          ...
          <div className="flex flex-col gap-6 rounded-3xl border border-border bg-card p-5 shadow-sm sm:p-8">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs sm:text-sm text-muted-foreground">
                  Título e detalhes informados aos clientes
                </p>
              </div>
            </div>
          ...
          <div className="flex flex-col gap-6 rounded-3xl border border-border bg-card p-5 shadow-sm sm:p-8">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs sm:text-sm text-muted-foreground">
                    Exemplos de trabalhos concluídos e antes/depois
                  </p>
                </div>
              </div>
            ...
            <input
              ...
              className="hidden"
              id="additional-photos-input-edit"
            />
