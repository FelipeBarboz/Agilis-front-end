...
import { SchedulingStats } from "./_components/scheduling-stats/scheduling-stats";
...
export default function SchedulingProviderPage() {
  ...
  return (
    <div className="flex flex-1 flex-col bg-muted/40 pb-20">
