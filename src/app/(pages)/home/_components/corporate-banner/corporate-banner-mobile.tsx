...
export function CorporateBannerMobile() {
  ...
  return (
    <FadeInSection>
      <div className="relative flex min-h-32.5 items-center overflow-hidden rounded-2xl bg-primary px-6 sm:px-10">

        <motion.p
          className="z-10 max-w-75 sm:max-w-85 text-lg sm:text-xl leading-snug font-bold text-foreground"
        ...
        <motion.div
          className="z-10 ml-auto mr-4 sm:mr-60"
          initial={{ opacity: 0, x: 16 }}
          whileInView={{ opacity: 1, x: 0 }}
          viewport={{ once: true }}
