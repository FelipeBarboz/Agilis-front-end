...
import { CancelledContent } from "./_components/cancelled-content";
      ...
      <div className="mx-auto w-full max-w-2xl space-y-6">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Acompanhe o status do estorno e as informações do serviço cancelado
          </p>
        </div>
          ...
          <Suspense
            fallback={
              <div className="flex flex-col items-center justify-center py-20 gap-3">
                ...
                <p className="text-sm text-muted-foreground">Carregando detalhes do cancelamento...</p>
              </div>
            }
          >
            <CancelledContent />
