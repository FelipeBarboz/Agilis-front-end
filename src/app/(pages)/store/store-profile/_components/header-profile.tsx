...
export function HeaderProfile() {
  return (
    <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6 bg-card p-6 sm:p-8 rounded-3xl shadow-sm border border-border">
      {/* Avatar */}
      ...
      <div className="flex flex-col items-center sm:items-start flex-1 gap-4 pt-2">
        ...
        <div className="flex flex-wrap items-center justify-center sm:justify-start gap-3 mt-2">
          <Button asChild variant="outline" className="gap-2 rounded-xl border-border hover:bg-muted">
