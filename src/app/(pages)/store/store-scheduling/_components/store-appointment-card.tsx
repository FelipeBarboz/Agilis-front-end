...
interface StoreAppointmentCardProps {
        ...
        <div>
          ...
          <div className="mt-1 flex flex-wrap items-center gap-x-3 gap-y-1 text-muted-foreground">
            ...
            <div className="flex items-center gap-1.5 text-primary">
              ...
              <span className="text-xs font-medium">Profissional: {appointment.employeeName}</span>
            </div>
          </div>
        </div>
        <span
      ...
      {appointment.status === "pending" && (
        <div className="flex gap-2 pt-1">
          <button
            ...
            className="flex-1 rounded-xl bg-primary py-2 text-xs font-bold text-white transition-colors hover:bg-primary/90 cursor-pointer"
          >
            Confirmar
          </button>
          <button
